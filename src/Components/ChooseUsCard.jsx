  ...
  return (
    ...
    >
      ...
      <div className="flex gap-4 ">
        <CustomButton {...{text:"Learn More", textColor:"black"}}/>
        <CustomButton {...{text:"Contact Us", textColor:"black"}}/>
